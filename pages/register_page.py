...
class RegisterPage(BasePage):
    ...
    def register(self, email, password, pid, confirm_password=None):
        conf_pass = confirm_password if confirm_password is not None else password
        
        self.do_send_keys(self.EMAIL_TXT, email)
        self.do_send_keys(self.PASSWORD_TXT, password)
        self.do_send_keys(self.CONFIRM_PASSWORD_TXT, conf_pass)
